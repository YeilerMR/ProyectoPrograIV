document.addEventListener("DOMContentLoaded", function () {
    ...
    var btnAgregar = document.getElementById("crear2");
    //var btnAgregar = document.querySelector(".add_new");
    //var spanCrear = document.querySelector("#crear_factura .close");
    var spanCrear = document.getElementById("#myModalCrearCliente .close");
